...
import { SharedPromptData } from "@/lib/share";
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="bg-bg-card rounded-2xl border border-border-subtle p-8 max-w-md w-full text-center">
          ...
          <p className="text-sm text-text-muted mb-6">
            This shared link may have expired or doesn&apos;t exist. Short links expire after 90 days.
          </p>
          <a
            href="/"
